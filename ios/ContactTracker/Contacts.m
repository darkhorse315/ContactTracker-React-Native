...
-(void) updateRecord:(CNMutableContact *)contact withData:(NSDictionary *)contactData
{
	...
	for (id socialProfileData in [contactData valueForKey:@"socialProfiles"]) {
        ...
        NSString *value = [socialProfileData valueForKey:@"value"];
		RCTLogInfo(@"Attempting to create a CNSocialProfile %@", label);
		if(label) {
// let facebookProfile = CNLabeledValue(label: "Facebook", value: CNSocialProfile(urlString: "https://www.facebook.com/appsfoundation", username: "AppsFoundation", userIdentifier: "appsfoundation", service: CNSocialProfileServiceFacebook))let twitterProfile = CNLabeledValue(label: "Twitter", value: CNSocialProfile(urlString: "https://twitter.com/AppsFoundation", username: "AppsFoundation", userIdentifier: "appsfoundation", service: CNSocialProfileServiceTwitter))
...
//			CNSocialProfile *socialProfile = [[CNSocialProfile alloc]initWithUrlString:@"https://www.facebook.com/appsfoundation" username:@"AppsFoundation" userIdentifier:@"appsfoundation" service:CNSocialProfileServiceFacebook];
			CNSocialProfile *socialProfile = [[CNSocialProfile alloc]initWithUrlString:urlString username:username userIdentifier:userIdentifier service:label];
            [socialProfiles addObject:[[CNLabeledValue alloc] initWithLabel:label value:socialProfile]];
			RCTLogInfo(@"added %@", label);
        }	
	}
